...
|:--------:|:---------------:|:-----------------:|:-----------------:|:-----------------:|:-----------------:|
|  Total   | `1/264 (0.38%)` | `25/191 (13.09%)` |  `23/585 (3.93%)` | `44/241 (18.26%)` | `49/1040 (4.71%)` |
| Windows  |  `0/0 (0.00%)`  |  `12/58 (20.69%)` |   `0/2 (0.00%)`   |  `12/36 (33.33%)` |  `12/60 (20.00%)` |
|   *nix   |  `0/0 (0.00%)`  |  `13/133 (9.77%)` |  `23/583 (3.95%)` | `32/168 (19.05%)` |  `36/716 (5.03%)` |
| OSCPlike |  `0/37 (0.00%)` |  `24/83 (28.92%)` | `20/121 (16.53%)` |                   | `44/241 (18.26%)` |
