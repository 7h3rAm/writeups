...
|:--------:|:---------------:|:----------------:|:-----------------:|:-----------------:|:-----------------:|
|  Total   | `1/492 (0.20%)` | `25/263 (9.51%)` |  `24/725 (3.31%)` | `46/254 (18.11%)` | `50/1480 (3.38%)` |
| Windows  |  `0/0 (0.00%)`  | `12/74 (16.22%)` |   `0/2 (0.00%)`   |  `12/39 (30.77%)` |  `12/76 (15.79%)` |
|   *nix   |  `0/0 (0.00%)`  | `13/189 (6.88%)` |  `24/723 (3.32%)` | `34/177 (19.21%)` |  `37/912 (4.06%)` |
